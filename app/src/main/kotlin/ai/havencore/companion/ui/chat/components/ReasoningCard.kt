...
/**
 * Inline expandable row for one reasoning iteration. Default-collapsed
 * (streams can be long). The parent assistant card owns the visual
 * frame; this row stays flat.
 */
@Composable
fun ReasoningRow(reasoning: TurnEvent.Reasoning, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "Reasoning · iteration ${reasoning.iteration}",
